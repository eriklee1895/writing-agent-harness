...
summary: "我把 viral 的 Gauntlet Loop 跑了 11 组对照实验，又用它迭代 10 轮做了款国风消消乐。结论：魔法不在 prompt 里，在持续集成、具体的 bar，和“不许作者给自己 merge PR”。"
...
![三道裂缝：评委不是 AI / 并行会翻车 / 游戏从没赢过](assets/infographic-cracks.png)
...
![11 组实验，谁赢了](assets/infographic-results.png)
...
![三层评委，顺序不能反](assets/infographic-critics.png)
